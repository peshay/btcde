...
class TestBtcdeAPIDocu(TestCase):
    ...
    def test_show_orderbook(self, m):
        ...
        url_args = '?price={}&trading_pair={}&type={}'.format(params.get('price'), params.get('trading_pair'), params.get('type'))
        response = {
           "orders":{
               "order_id": "A1B2D3",
               "trading_pair": "btceur",
        ...
        m.get(requests_mock.ANY, json=response, status_code=200)
        btcde.showOrderbook(self.conn, params.get('type'), params.get('trading_pair'), price=params.get('price'))
        history = m.request_history
    ...
    def test_createOrder(self, m):
        ...
        params = { 'type': 'buy',
                   ...
                   'price': 13 }     
        base_url = 'https://api.bitcoin.de/v2/orders'
        url_args = '?max_amount={}&price={}&trading_pair={}&type={}'.format(params.get('max_amount'), params.get('price'), params.get('trading_pair'), params.get('type'))
        response = { "order_id": "A1234BC",
                     "errors": [],
                     "credits": 8 }
        m.post(requests_mock.ANY, json=response, status_code=201)
        btcde.createOrder(self.conn, params.get('type'), params.get('trading_pair'), params.get('max_amount'), price=params.get('price'))
        history = m.request_history
    ...
    def test_deleteOrder(self, m):
        ...
        params = {'trading_pair': 'btceur',
                  'order_id': '1337'}
        base_url = 'https://api.bitcoin.de/v2/orders'
        url_args = '/{}/{}'.format(params.get('order_id'), params.get('trading_pair'))
        response = { "errors": [],
                     "credits": 5 }
        m.delete(requests_mock.ANY, json=response, status_code=200)
        btcde.deleteOrder(self.conn, params.get('order_id'), params.get('trading_pair'))
        history = m.request_history
    ...
    def test_showMyOrders(self, m):
        ...
        m.get(requests_mock.ANY, json=response, status_code=200)
        btcde.showMyOrders(self.conn, type=params.get('type'), trading_pair=params.get('trading_pair'), price=params.get('price'))
        history = m.request_history
        self.assertEqual(history[0].method, "GET")
        self.assertEqual(history[0].url, base_url + url_args)
    ...
    def test_showMyOrderDetails(self, m):
        ...
        base_url = 'https://api.bitcoin.de/v2/orders/{}'.format(params.get('order_id'))
        url_args = ''
        response = {"order":
                   {
                       "order_id": "2EDYNS",
    ...
    def test_executeTrade(self, m):
        ...
        params = { 'type': 'buy',
                   ...
                   'amount': '10',
                   'order_id': '1337' }
        base_url = 'https://api.bitcoin.de/v2/trades/{}'.format(params.get('order_id'))
        url_args = '?amount={}&order_id={}&trading_pair={}&type={}'.format(params.get('amount'), params.get('order_id'), params.get('trading_pair'), params.get('type'))
        response = { "errors": [],
                     "credits": 8 }
        m.post(requests_mock.ANY, json=response, status_code=201)
        btcde.executeTrade(self.conn, params.get('order_id'), params.get('type'), params.get('trading_pair'), params.get('amount'))
        history = m.request_history
        self.assertEqual(history[0].method, "POST")
        self.assertEqual(history[0].url, base_url + url_args)
    ...
    def test_showMyTrades_with_params(self, m):
        ...
        params = { 'type': 'buy',
                   'trading_pair': 'btceur' }
        base_url = 'https://api.bitcoin.de/v2/trades'
        url_args = '?trading_pairs={}&type={}'.format(params.get('trading_pairs'), params.get('type'))
        response = {"order":
                   {
                       "order_id": "2EDYNS",
                       "trading_pair": "btceur",
        ...
        m.get(requests_mock.ANY, json=response, status_code=200)
        btcde.showMyTrades(self.conn, type=params.get('type'), trading_pairs=params.get('trading_pairs'))
        history = m.request_history
        self.assertEqual(history[0].method, "GET")
        self.assertEqual(history[0].url, base_url + url_args)
